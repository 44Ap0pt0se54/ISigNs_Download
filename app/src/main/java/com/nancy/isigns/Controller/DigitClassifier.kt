...
class DigitClassifier(private val context: Context) {
    ...
    public fun initialize(): Task<Void?> {
    ...
    private fun initializeInterpreter() {
        ...
        val model = loadModelFile(assetManager, "ModelAlpha305070.tflite")
    ...
    companion object {
        private const val TAG = "com.nancy.isigns.Controller.DigitClassifier"
